class March{
   ...
   public void show(int i){
    ...
    for(int u = 0; triangulation[cubeIndex][u] != -1; u = u+3){
      ...
      tri[i].vertexA = interpolateVerts(cubeCorners[a0].pos, cubeCorners[b0].pos, cubeCorners[a0].pointNoise, cubeCorners[b0].pointNoise);
      tri[i].vertexB = interpolateVerts(cubeCorners[a1].pos, cubeCorners[b1].pos, cubeCorners[a1].pointNoise, cubeCorners[b1].pointNoise);
      tri[i].vertexC = interpolateVerts(cubeCorners[a2].pos, cubeCorners[b2].pos, cubeCorners[a2].pointNoise, cubeCorners[b2].pointNoise);
